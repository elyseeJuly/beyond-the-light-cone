...
export function buildSteps(hasStope: boolean, initialMiningRatio: number = NaN): TutorialStep[] {
  return [
    ...
    },
    {
      ...
      highlightTarget: t("tech-node-天文观测"),
      activeView: 'techtree',
      cardPosition: 'right',
      requiresManualAdvance: true,
      completionEvent: SemanticTutorialEvent.MANUAL_ADVANCE,
    ...
    },
    {
      id: 'next-turn',
      title: t("执行首回合决策"),
      description: t("点击「下一回合」。时间将向前推移，智脑将演算各部门运转效果。"),
    ...
    },
    {
      id: 'resolve-event',
      title: t("应对突发危机"),
      description: t("智脑推演到危机事件。每一个抉择都将深刻书写文明的生存命运。"),
      activeView: 'starmap',
      cardPosition: 'center',
      requiresManualAdvance: true,
      completionEvent: SemanticTutorialEvent.MANUAL_ADVANCE,
    },
    {
      id: 'tutorial-end',
      title: t("智脑校准完毕"),
      description: t("校准完成！局势目标面板与智脑战术顾问已解锁，愿文明薪火永存。"),
      activeView: 'starmap',
      cardPosition: 'center',
      requiresManualAdvance: true,
