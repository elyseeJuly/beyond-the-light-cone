...
| SCEN-TUTORIAL-STEPS-MATCH | 设计偏离 | 教程步骤分类对齐 | D类：教程 category "基础操作" 无对应 LeftHub 导航项；LeftHub "岁月史书" 无对应教程分类 | 🟢 GREEN | 教程分类与 LeftHub 侧边栏导航已通过"岁月史书"对齐 | TutorialRemedy.scenario.test.tsx |
...
## 变更日志
- 2026-06-29: SCEN-TUTORIAL-STEPS-MATCH RED → GREEN（重构 Tutorial.tsx 的基础操作为岁月史书，已与 LeftHub 完全对齐并通过测试）
- 2026-06-29: SCEN-TUTORIAL-STEPS-MATCH GREEN → RED（代码审计发现：教程 category "基础操作" 无 LeftHub 匹配项，LeftHub "岁月史书" 无教程分类，立即可测试）
