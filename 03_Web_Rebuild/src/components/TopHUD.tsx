...
export const TopHUD: React.FC = () => {
  ...
  return (
    <header data-tutorial-id="top-hud" className="h-auto md:h-[72px] w-full bg-[#070B14]/80 backdrop-blur-[12px] border-b border-[#243245]/50 flex items-center justify-between px-3 md:px-6 z-50 select-none relative py-1.5 md:py-0">
