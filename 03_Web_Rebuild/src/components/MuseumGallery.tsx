...
const CG_EVENTS: CgEvent[] = [
  {
    ...
    name: t("红岸基地建立"),
    description: t("在大兴安岭深处，红岸基地悄然建立，承载着向太空探寻生命的最初渴望。"),
  ...
  },
  {
    ...
    name: t("叶文洁的呼唤"),
    description: t("“到这里来吧，我将帮助你们获得这个世界。”这声呼唤彻底改变了人类的命运。"),
    image: "cg_yewenjie_signal.png",
    era: t("黄金岁月"),
    hint: t("在黄金岁月选择【向宇宙发送红岸信号】触发")
  },
  {
    id: "event_trisolaris_reply",
    name: t("三体文明回复"),
    description: t("来自遥远异星文明的警告：“不要回答！不要回答！不要回答！”但文明的齿轮已然合上。"),
  ...
  },
  {
    ...
    name: t("地球三体组织成立"),
    description: t("人类精英的秘密聚会，高呼“消灭人类暴政，世界属于三体”，ETO 宣告诞生。"),
    image: "cg_eto_founded.png",
    era: t("黄金岁月"),
    hint: t("在危机纪元前夕接触伊文斯建立 ETO 触发")
  },
  {
    id: "event_crisis_start",
    name: t("危机纪元开启"),
    description: t("智子展开，封锁人类基础科学。末日之剑高悬，危机纪元大幕沉重开启。"),
  ...
  },
  {
    ...
    name: t("智子锁死科学"),
    description: t("三体智子干扰高能加速器，将人类基础物理锁死在现有水平，切断前沿探索。"),
  ...
  },
  {
    id: "event_guzheng",
    name: t("古筝行动"),
    description: t("在巴拿马运河，死亡的琴弦拂过，“审判日”号在一片寂静中被切割成薄片，彻底揭开了智子的秘密。"),
    image: "cg_guzheng.png",
    era: t("危机纪元"),
    hint: t("在危机纪元早期批准实施【古筝行动】触发")
  },
  {
    id: "event_moon_crisis",
    name: t("月球危机"),
    description: t("危机纪元中期的月球轨道核弹危机，人类不得不直面无垠深空带来的技术壁垒与考验。"),
    image: "cg_moon_crisis.png",
    era: t("危机纪元"),
    hint: t("在危机纪元第 50 年自动触发")
  },
  {
    id: "event_beihai_assassination",
    name: t("自然选择号启航"),
    description: t("章北海为了人类的延续，坚决执行飞船的太空出逃，刺杀顽固守旧派，留下深空火种。"),
    image: "cg_beihai_assassination.png",
    era: t("危机纪元"),
    hint: t("任命章北海并推进太空军工程触发")
  },
  {
    id: "event_teardrop_probe",
    name: t("水滴到达太阳系"),
    description: t("三体探测器“水滴”以优美而冷酷的强互作用力外壳抵达太阳系，震撼人类世界。"),
    image: "cg_teardrop_probe.png",
    era: t("危机纪元"),
    hint: t("经历水滴探测器到达剧情事件触发")
  },
  {
    id: "event_droplet_attack",
    name: t("末日战役 (水滴突袭)"),
    description: t("仅仅一颗微不足道的水滴，便如死神的穿梭针般，瞬间在太空中将人类两千多艘主力战舰化为火海。"),
    image: "cg_droplet_attack.png",
    era: t("危机纪元"),
    hint: t("遭遇三体水滴探测器交火触发")
  },
  {
    id: "event_deterrence_established",
    name: t("威慑建立 (执剑诞生)"),
    description: t("罗辑手握毁灭双世界的遥控器，以生命为筹码，迫使三体文明妥协，威慑纪元正式建立。"),
    image: "cg_deterrence_established.png",
    era: t("威慑纪元"),
    hint: t("罗辑成功建立黑暗森林威慑触发")
  },
  {
    id: "event_black_domain",
    name: t("黑域安全声明论证"),
    description: t("人类内部关于降低光速、在太阳系周围建立永久安全黑域以躲避黑森打击的可行性论证。"),
  ...
  },
  {
    ...
    name: t("威慑中止 (强袭废墟)"),
    description: t("执剑人交接的刹那，强互作用力水滴瞬间摧毁了所有的引力波广播天线，威慑崩塌。"),
    image: "cg_deterrence_broken.png",
    era: t("威慑纪元"),
    hint: t("程心接任执剑人并遭遇水滴突袭触发")
  },
  {
    id: "event_gravitational_broadcast",
    name: t("引力波广播"),
    description: t("“万有引力”号飞船在太空中广播了三体世界的坐标，黑暗森林的死神开始向两个世界踱步。"),
    image: "cg_gravitational_broadcast.png",
    era: t("广播纪元"),
    hint: t("万有引力号触发重力广播触发")
  },
  {
    id: "event_bunker_world",
    name: t("掩体世界太空城"),
    description: t("利用巨行星的阴影作为掩体，人类建立了宏大的太空城群，以躲避黑暗森林打击。"),
  ...
  },
  {
    ...
    name: t("曲率光速飞船研发"),
    description: t("维德在星环集团的暗中支持下，秘密开展人类首艘曲率驱动光速飞船的科研攻关。"),
    image: "cg_lightspeed_ship.png",
    era: t("掩体纪元"),
    hint: t("经历曲率光速飞船建造事件触发")
  },
  {
    id: "event_wandering_earth",
    name: t("行星发动机启航"),
    description: t("行星发动机在地表喷射出幽蓝火柱，带着故土的温存，人类决意开始长达数千年的星际远征。"),
    image: "cg_wandering_earth.png",
    era: t("掩体纪元"),
    hint: t("在掩体纪元第 300 年选择启动行星远征触发")
  },
  {
    id: "event_dimensional_warning",
    name: t("奥尔特星云重力凹陷"),
    description: t("雷达捕捉到太阳系边缘空间出现严重的引力塌缩，维度打击迫在眉睫的灾难前兆。"),
    image: "cg_dimensional_warning.png",
    era: t("掩体纪元"),
    hint: t("经历空间维度警报剧情事件触发")
  },
  {
    id: "event_pluto_museum",
    name: t("冥王星博物馆"),
    description: t("在太阳系的边缘，冥王星上建立起人类文明的最后遗迹博物馆，记录着这个种族存在过的痕迹。"),
    image: "cg_pluto_museum.png",
    era: t("银河纪元"),
    hint: t("遭遇二维化打击时进入冥王星触发")
  },
  {
    id: "event_solar_system_flattened",
    name: t("太阳系二维化"),
    description: t("歌者抛出的二向箔展开，太阳系的一切物质跌落为没有厚度的二维画作，人类无声谢幕。"),
    image: "cg_solar_system_flattened.png",
    era: t("银河纪元"),
    hint: t("遭遇二向箔打击并降维失败触发")
  },
  {
    id: "event_galaxy_exodus",
    name: t("银河远征星舰集结"),
    description: t("太阳系崩塌后，逃脱的光速飞船在银河深处汇合，星舰文明的人类向着未知远海启航。"),
    image: "cg_galaxy_exodus.png",
    era: t("银河纪元"),
    hint: t("经历银河远征启航剧情事件触发")
  },
  {
    id: "event_zeroer_broadcast",
    name: t("归零者超空间广播"),
    description: t("归零者向全宇宙广播归还大宇宙质量的超维倡议，推动宇宙重启至原始的十维田园状态。"),
    image: "cg_zeroer_broadcast.png",
    era: t("星屑纪元"),
    hint: t("经历归零者超空间广播事件触发")
  }
];
...
const SOUNDTRACKS: Track[] = [
  // Era BGMs
  {
    ...
    description: t("黄金岁月与主界面背景乐。庄严的主导动机，诠释人类迈向太空的坚实底座。"),
    isEnding: false,
    unlockConditionText: t("默认解锁"),
    unlockCheck: () => true,
  ...
  },
  {
    ...
    description: t("危机纪元背景乐。沉重工业管弦，如时钟般无情滴答，昭示末日倒计时的压迫感。"),
    isEnding: false,
    unlockConditionText: t("默认解锁"),
    unlockCheck: () => true,
  ...
  },
  {
    ...
    description: t("威慑纪元背景乐。极简暗色氛围，悬而未决的低音大提琴，如钢丝上的脆弱平衡。"),
    isEnding: false,
    unlockConditionText: t("默认解锁"),
    unlockCheck: () => true,
  ...
  },
  {
    ...
    description: t("广播纪元背景乐。嘈杂交响金属，混杂着支离破碎的警报与电台杂音，秩序崩塌的终曲。"),
    isEnding: false,
    unlockConditionText: t("默认解锁"),
    unlockCheck: () => true,
  ...
  },
  {
    ...
    description: t("掩体纪元背景乐。沉闷的次低音与金属舱壁共振，仿佛躲藏在巨星阴影下的密闭太空城。"),
    isEnding: false,
    unlockConditionText: t("默认解锁"),
    unlockCheck: () => true,
  ...
  },
  {
    ...
    description: t("银河纪元背景乐。辽阔的宇宙氛围中，孤独的单音钢琴回响，交织着虚无的女声哼唱。"),
    isEnding: false,
    unlockConditionText: t("默认解锁"),
    unlockCheck: () => true,
  ...
  },
  {
    ...
    description: t("星屑纪元背景乐。空灵而唯美的后摇滚，闪烁的颗粒合成器音色，化作消散在太虚中的微光。"),
    isEnding: false,
    unlockConditionText: t("默认解锁"),
    unlockCheck: () => true,
  ...
  // Vocal Themes
  {
    name: t("Stardust Exodus (星屑启航)"),
    englishName: "True Ending Vocal Theme",
    path: "/audio/ending_stardust_exodus.mp3",
    description: t("【真结局主题曲】流浪远航 / 星际征服胜利。交响电子与空灵女声人声演唱，极具爆发力与史诗感。"),
    isEnding: true,
    unlockConditionText: t("达成「星际征服胜利」或「流浪胜利」解锁"),
  ...
  {
    name: t("Fate Beyond the Light Cone (光锥之外的命运)"),
    englishName: "Platinum Credits Vocal Theme",
    path: "/audio/ending_fate_beyond_the_light_cone.mp3",
    description: t("【白金成就终章曲】全图鉴解锁演播。汉斯·季默式宏大交响乐，人声吟唱，文明永恒赞歌。"),
    isEnding: true,
    unlockConditionText: t("解锁所有结局解锁"),
  ...
  // Victory Epilogues
  {
    name: t("征服之章 (Conquest Victory)"),
    englishName: "Epilogue theme",
    path: "/audio/ending_conquest.mp3",
    description: t("征服胜利结局配乐。冷酷的军乐铜管，宣告黑暗森林最强大猎手的凯旋。"),
    isEnding: true,
    unlockConditionText: t("达成「征服胜利」解锁"),
    unlockCheck: (unlocks) => unlocks.has("unlocked_victory_0"),
  },
  {
    name: t("威慑和平 (Deterrence Victory)"),
    englishName: "Epilogue theme",
    path: "/audio/ending_deterrence.mp3",
    description: t("威慑胜利结局配乐。高悬的庄严旋律，夹杂着心跳起伏的低频，表现这难得却危如累卵的和平。"),
    isEnding: true,
    unlockConditionText: t("达成「威慑胜利」解锁"),
    unlockCheck: (unlocks) => unlocks.has("unlocked_victory_1"),
  },
  {
    name: t("光锥之死 (Death of the Light Cone)"),
    englishName: "Dark Domain Ending theme",
    path: "/audio/ending_death_of_the_light_cone.mp3",
    description: t("黑域结局配乐。慢速安魂曲，神圣的无字唱诗班，凝固在降至零的永恒琥珀之中。"),
    isEnding: true,
    unlockConditionText: t("达成「黑域胜利」解锁"),
    unlockCheck: (unlocks) => unlocks.has("unlocked_victory_2"),
  },
  {
    name: t("流浪远航 (Wandering Victory)"),
    englishName: "Epilogue theme",
    path: "/audio/ending_wandering.mp3",
    description: t("流浪胜利结局配乐。深邃而坚韧的管弦起伏，伴随发动机的重重推力，驶向遥远的半人马座。"),
    isEnding: true,
    unlockConditionText: t("达成「流浪胜利」解锁"),
    unlockCheck: (unlocks) => unlocks.has("unlocked_victory_3"),
  },
  {
    name: t("量子幽灵 (Ghost in the Quantum)"),
    englishName: "Digital Ending theme",
    path: "/audio/ending_ghost_in_the_quantum.mp3",
    description: t("数字永生结局配乐。电子浪潮与冷酷的赛博朋克合成器，宣告碳基肉身的逝去，硅基意识之永恒。"),
    isEnding: true,
    unlockConditionText: t("达成「数字永生」解锁"),
    unlockCheck: (unlocks) => unlocks.has("unlocked_victory_4"),
  },
  {
    name: t("最后的档案 (The Last Archive)"),
    englishName: "Hidden Ending theme",
    path: "/audio/ending_the_last_archive.mp3",
    description: t("隐藏结局配乐。忧伤的独奏钢琴与斑驳的老电台白噪音，最后翻书声落，归于绝对寂静。"),
    isEnding: true,
    unlockConditionText: t("达成「死神永生·小宇宙」结局解锁"),
    unlockCheck: (unlocks) => unlocks.has("unlocked_victory_5"),
  },

  // Defeat Epilogues
  {
    name: t("内讧崩塌 (Treachery Defeat)"),
    englishName: "Defeat theme",
    path: "/audio/ending_defeat_treachery.mp3",
    description: t("逃亡主义失控失败配乐。凌乱扭曲的弦乐，刻画无序内耗中逐渐熄灭的人性与文明秩序。"),
    isEnding: true,
    unlockConditionText: t("达成「文明崩溃（逃亡主义失控）」结局解锁"),
    unlockCheck: (unlocks) => unlocks.has("unlocked_defeat_0"),
  },
  {
    name: t("死寂星尘 (Extinction Defeat)"),
    englishName: "Defeat theme",
    path: "/audio/ending_defeat_extinction.mp3",
    description: t("文明灭绝失败配乐。单调的电磁背景音与宇宙风暴，记录归于尘埃后的死寂星球。"),
    isEnding: true,
    unlockConditionText: t("达成「文明灭绝（最后的沉默）」结局解锁"),
    unlockCheck: (unlocks) => unlocks.has("unlocked_defeat_1"),
  },
  {
    name: t("恒星终焉 (Helium Flash Defeat)"),
    englishName: "Defeat theme",
    path: "/audio/ending_defeat_helium_flash.mp3",
    description: t("太阳氦闪失败配乐。突然膨胀 of 轰鸣管弦与极致的爆发感，在白光中蒸发一切遗恨。"),
    isEnding: true,
    unlockConditionText: t("达成「太阳氦闪（恒星终焉）」结局解锁"),
    unlockCheck: (unlocks) => unlocks.has("unlocked_defeat_2"),
  },
  {
    name: t("纸面永眠 (Dimension Strike Defeat)"),
    englishName: "Defeat theme",
    path: "/audio/ending_defeat_dimension_strike.mp3",
    description: t("二向箔降维打击失败配乐。奇异的频率坍缩，三维物质跌落平原时的空虚啸叫。"),
    isEnding: true,
    unlockConditionText: t("达成「二向箔降维（空间坍缩）」结局解锁"),
    unlockCheck: (unlocks) => unlocks.has("unlocked_defeat_3"),
  },

  // Neutral Epilogues
  {
    name: t("无尽漂流 (Eternal Exile)"),
    englishName: "Neutral Exile theme",
    path: "/audio/ending_neutral_eternal_exile.mp3",
    description: t("永恒的流亡结局配乐。迷茫而苍凉的电子低吟，诉说着失去太阳的人类在幽暗虚空中的无尽漂泊。"),
    isEnding: true,
    unlockConditionText: t("达成「永恒的流亡」结局解锁"),
    unlockCheck: (unlocks) => unlocks.has("unlocked_neutral_0") || unlocks.has("unlocked_neutral_ETERNAL_EXILE"),
  },
  {
    name: t("星海归于静默 (Cosmic Silence)"),
    englishName: "Neutral Silence theme",
    path: "/audio/ending_neutral_cosmic_silence.mp3",
    description: t("宇宙静默结局配乐。微弱舒缓的电磁背景音与渐行渐远的长笛，宣告一个喧嚣种族的终极宁静。"),
    isEnding: true,
    unlockConditionText: t("达成「宇宙静默」结局解锁"),
            ...
            <section className="space-y-4 pb-12">
              ...
              {history.length === 0 ? (
                <div className="p-8 border border-white/5 bg-white/[0.01] rounded-xl text-center">
                  ...
                  <p className="text-white/40 text-sm italic">{t("暂无历史通关记录，请带带领袖们完成首个结局。")}</p>
                </div>
              ) : (
                <div className="space-y-3">
                  {[...history].reverse().map((record, idx) => {
                    const epochLabels = [t("黄金岁月"), t("危机纪元"), t("威慑纪元"), t("广播纪元"), t("掩体纪元"), t("银河纪元"), t("星屑纪元")];
                    const epochName = epochLabels[record.epoch] || t("未知纪元");
                        ...
                        <div className="flex items-center gap-4">
                          ...
                          <div>
                            ...
                            <div className="text-[10px] text-white/40 mt-1 font-mono">
                              {t("达成时间：")}{new Date(record.timestamp).toLocaleString()} {t("| 纪元历程：")}{epochName} {record.year} {t("年")}</div>
                          </div>
                        </div>
          ...
          <div className="space-y-6 pb-12 flex-1 animate-in fade-in slide-in-from-bottom-2 duration-300">
            <div className="flex items-center justify-between border-b border-white/5 pb-3">
              <h3 className="text-sm font-mono tracking-widest text-cyan-400 uppercase font-bold flex items-center gap-2">
                ...
                {t("纪元历史浮光 (Major Event CG Gallery)")}</h3>
                    ...
                    <div className="p-3.5 flex-1 flex flex-col justify-between gap-2">
                      <div>
                        ...
                        <p className={`text-[10px] leading-relaxed mt-1 font-light ${isUnlocked ? 'text-white/50' : 'text-white/20'}`}>
                          {isUnlocked ? t(cg.description) : t("{param0} {param1}", { param0: t('解锁线索:'), param1: t(cg.hint) })}
                        </p>
                      </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start pb-12 flex-1 animate-in fade-in slide-in-from-bottom-2 duration-300">
            ...
            <div className="lg:col-span-4 lg:sticky lg:top-6 bg-white/[0.02] border border-white/10 rounded-2xl p-6 flex flex-col items-center gap-6 backdrop-blur-md relative overflow-hidden">
              ...
              <div className="text-center w-full min-h-[4rem] px-2 flex flex-col justify-center">
                {currentPlayingTrack ? (
                  ...
                  <>
                    <h4 className="text-white/30 text-sm italic">{t("请在右侧选择曲目播放")}</h4>
              ...
              <div className="flex items-center gap-4 w-full justify-center">
                ...
                <button 
                  ...
                  title={isPlayingPreview ? t("暂停") : t("播放")}
                >
                ...
                <div className="w-full mt-2 pt-4 border-t border-white/5 flex flex-col gap-2">
                  <div className="flex justify-between items-center bg-cyan-950/20 border border-cyan-500/20 rounded-lg p-2.5">
                    <div className="flex flex-col">
                      <span className="text-[9px] font-mono text-cyan-400/80 uppercase tracking-widest font-bold">{t("已启用自定义背景乐")}</span>
                      <span className="text-xs text-white/70 font-bold mt-0.5 truncate max-w-[150px]">
                        《{SOUNDTRACKS.find(t => t.path === customBgm)?.name || t("未知曲目")}》
                      </span>
                    </div>
                    <button 
            ...
            <div className="lg:col-span-8 space-y-6">
              ...
              <section className="space-y-3">
                <h3 className="text-sm font-mono tracking-widest text-cyan-400 uppercase font-bold flex items-center gap-2">
                  <span className="w-2 h-2 rounded bg-cyan-400" />
                  {t("纪元编年律动 (Gameplay Era BGMs)")}<span className="text-[10px] text-white/30 font-normal tracking-wide lowercase italic font-sans">{t("(支持设为游戏背景乐)")}</span>
                </h3>
              ...
              <section className="space-y-3">
                <h3 className="text-sm font-mono tracking-widest text-purple-400 uppercase font-bold flex items-center gap-2">
                  ...
                  {t("史书大结局与特制主题曲 (Ending Themes)")}<span className="text-[10px] text-white/30 font-normal tracking-wide lowercase italic font-sans">{t("(达成对应结局解锁)")}</span>
                </h3>
                        ...
                        <div className="flex items-start gap-4">
                          ...
                          <div className="space-y-1">
                            ...
                            <p className={`text-xs leading-relaxed max-w-lg ${isUnlocked ? 'text-white/50' : 'text-white/20'}`}>
                              {isUnlocked ? track.description : t("[锁定状态] {param0}", { param0: track.unlockConditionText })}
                            </p>
                          </div>
                        </div>
