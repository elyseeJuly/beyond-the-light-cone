...
| :--- | :--- | :--- | :--- | :--- |
| 1 | **征服胜利** (CONQUEST) | `ending_conquest.mp3` | 《Conquest of the Dark Forest》 / 军乐铜管 | `[Instrumental] Cinematic space opera, cold and aggressive military brass, heavy orchestral percussion, dark forest hunter's triumph, majestic but ruthless, epic scale, 100 BPM.` |
| 2 | **威慑胜利** (DETERRENCE) | `ending_deterrence.mp3` | 《Sword of Damocles》 / 极简威压 | `[Instrumental] Cinematic dark ambient, solemn elevated strings melody, pulsating sub-bass heartbeat, fragile balance of power, suspended tension, majestic but terrifying, Hans Zimmer style, 70 BPM.` |
| 3 | **黑域声明胜利** (DARK_DOMAIN) | `ending_death_of_the_light_cone.mp3` | 《Death of the Light Cone》 / 光速墓碑 | `[Instrumental] Slow requiem, dark ambient classical, wordless sacred choir, tragic and solemn, trapped in eternity, fading tempo.` |
| 4 | **流浪地球胜利** (WANDERING) | `ending_wandering.mp3` | 《Wandering Star》 / 管弦交响 | `[Instrumental] Epic cinematic orchestral, deep and resilient string swells, heavy rhythmic brass representing massive engine thrust, interstellar journey, determined, hopeful yet sorrowful, Hans Zimmer style, 80 BPM.` |
...
| 7 | **真结局群星** (TRUE_ENDING) | `ending_stardust_exodus.mp3` | 《Stardust Exodus》 / **[真结局人声Vocal]** | `J-RPG space opera soundtrack, symphonic EDM mixed with orchestral rock, high energy, ethereal but powerful anime-style female vocals, dramatic choir, grand cosmic epic.` |
| 8 | **白金成就名单** (CREDITS_PLATINUM) | `ending_fate_beyond_the_light_cone.mp3` | 《A Past Within the Light Cone》 / **[人声Vocal]** | `Cinematic emotional masterpiece, starts with minimalist lonely piano, slowly building into full cinematic orchestral climax. Soulful and powerful female vocal, nostalgic, overwhelmingly emotional, Hans Zimmer style epic finish.` |
| 9 | **永恒的流亡** (NEUTRAL_ETERNAL_EXILE) | `ending_neutral_eternal_exile.mp3` | 《Endless Drifting》 / 寂寞流浪纯乐 | `[Instrumental] Melancholic space ambient, distant cello, echoing soft synth, feeling of endless drifting, vast emptiness, sorrowful but determined, deep space nomadic vibe, slow tempo, 60 BPM.` |
| 10 | **宇宙静默** (NEUTRAL_COSMIC_SILENCE) | `ending_neutral_cosmic_silence.mp3` | 《Absolute Zero》 / 绝对零度极简 | `[Instrumental] Minimalist drone, absolute zero ambient, very low frequency hum, sparse crystal chimes fading into the void, emotionless, vast, cold, cosmic background radiation, 40 BPM.` |
| 11 | **逃亡主义失败** (DEFEAT_TREACHERY) | `ending_defeat_treachery.mp3` | 《Collapse from Within》 / 扭曲弦乐 | `[Instrumental] Dissonant modern classical, chaotic twisted string section, erratic tempo, collapsing civilization order, fading humanity, despair, psychological horror, descending into madness.` |
| 12 | **文明灭绝失败** (DEFEAT_EXTINCTION) | `ending_defeat_extinction.mp3` | 《Dead Planet》 / 死寂星尘 | `[Instrumental] Dark space ambient, monotonous electromagnetic drone, distant cosmic storm sounds, dead planet atmosphere, absolute silence underneath, cold, fading into dust, 40 BPM.` |
| 13 | **太阳氦闪失败** (DEFEAT_HELIUM_FLASH) | `ending_defeat_helium_flash.mp3` | 《The Last Flash》 / 膨胀轰鸣 | `[Instrumental] Explosive cinematic orchestral, sudden massive crescendo, overwhelming brass and choir, blinding flash of light, apocalyptic destruction, evaporating into white noise, abrupt end.` |
| 14 | **二向箔降维** (DEFEAT_DIMENSION_STRIKE) | `ending_defeat_dimension_strike.mp3` | 《2D Tomb》 / 频率坍缩啸叫 | `[Instrumental] Avant-garde electronic, bizarre frequency collapsing, pitch dropping, spatial distortion, empty howling synths, dimensional strike, flattening into 2D plane, eerie and surreal.` |
