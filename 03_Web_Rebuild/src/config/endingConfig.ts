...
export const ENDING_BGM_PATHS = {
  ...
  DEFEAT_TREACHERY: '/audio/ending_defeat_treachery.mp3',       // 背叛失败
  DEFEAT_EXTINCTION: '/audio/ending_defeat_extinction.mp3',     // 灭绝失败
  DEFEAT_HELIUM_FLASH: '/audio/ending_defeat_helium_flash.mp3', // 氦闪失败
  DEFEAT_DIMENSION_STRIKE: '/audio/ending_defeat_dimension_strike.mp3', // 二向箔失败
