...
[![Version](https://img.shields.io/badge/Version-v1.0.8-ff6f00.svg)](#)
[![Play Online](https://img.shields.io/badge/Play_Online-GitHub_Pages-success.svg)](https://elyseejuly.github.io/beyond-the-light-cone/?v=1.0.8)
...
👉 **[在线游玩 · Web 正式版 v1.0.8](https://elyseejuly.github.io/beyond-the-light-cone/?v=1.0.8)** 👈
...
| 🤖 **AI 智脑顾问** | 接入前沿大语言模型（LLM），在复杂的外交、科研与战术决策中提供实时沙盘推演与战略建议 |
...
| 🎬 **纯代码电影化宣发管线** | 内置基于 Remotion 的 React 视频生成引擎，支持自动化渲染 90 秒史诗级多语言预告片 |
